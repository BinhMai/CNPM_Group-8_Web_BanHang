   ...
   $('.add-cart').click(function(){                       
      ...
      $.ajax({
         ...
         success:function(data){   
            ...
            $('.button_group_'+id).html('<a href="/details='+id+'"><button class="button" style="margin-left: 25px">More Detail</button></a><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button>');                                
